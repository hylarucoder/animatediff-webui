...
def get_weighted_text_embeddings_sdxl2(
    ...
    for prompt, neg_prompt in zip(prompt_list, neg_prompt_list):
        ...
        prompt_weights_list.append(prompt_weights)
    ...
    for prompt, neg_prompt in zip(prompt_list, neg_prompt_list):
        # tokenizer 2
        prompt_tokens_2, prompt_weights_2 = get_prompts_tokens_with_weights(pipe.tokenizer_2, prompt)
        prompt_tokens_2_list.append(prompt_tokens_2)
        prompt_weights_2_list.append(prompt_weights_2)

        neg_prompt_tokens_2, neg_prompt_weights_2 = get_prompts_tokens_with_weights(pipe.tokenizer_2, neg_prompt)
        neg_prompt_tokens_2_list.append(neg_prompt_tokens_2)
        neg_prompt_weights_2_list.append(neg_prompt_weights_2)
    ...
    prompt_tokens_list, prompt_weights_list, neg_prompt_tokens_list, neg_prompt_weights_list = padding(
        prompt_tokens_list, prompt_weights_list, neg_prompt_tokens_list, neg_prompt_weights_list
    )

    prompt_tokens_2_list, prompt_weights_2_list, neg_prompt_tokens_2_list, neg_prompt_weights_2_list = padding(
        prompt_tokens_2_list, prompt_weights_2_list, neg_prompt_tokens_2_list, neg_prompt_weights_2_list
    )
    ...
    def get_embeddings(
        ...
        prompt_token_groups, prompt_weight_groups = group_tokens_and_weights(
            prompt_tokens.copy(), prompt_weights.copy(), True
        )

        neg_prompt_token_groups, neg_prompt_weight_groups = group_tokens_and_weights(
            neg_prompt_tokens.copy(), neg_prompt_weights.copy(), True
        )

        prompt_token_groups_2, prompt_weight_groups_2 = group_tokens_and_weights(
            prompt_tokens_2.copy(), prompt_weights_2.copy(), True
        )

        neg_prompt_token_groups_2, neg_prompt_weight_groups_2 = group_tokens_and_weights(
            neg_prompt_tokens_2.copy(), neg_prompt_weights_2.copy(), True
        )
    ...
    for i in range(len(prompt_tokens_list)):
        p, n, pp, np = get_embeddings(
            ...
            neg_prompt_weights_list[i],
            prompt_tokens_2_list[i],
            prompt_weights_2_list[i],
            neg_prompt_tokens_2_list[i],
            neg_prompt_weights_2_list[i],
        )
        p_list.append(p)
        n_list.append(n)
        pp_list.append(pp)
