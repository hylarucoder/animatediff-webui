  ...
  <v-f-modal-layout>
    ...
    <template v-slot:buttons>
      <button
        ...
        :class="
          disableUploadButton
            ? 'bg-blue-200 hover:bg-blue-200 dark:bg-gray-700/50 dark:text-gray-500 dark:hover:bg-gray-700/50'
...
onMounted(() => {
  uploader.value = new plupload.Uploader({
    ...
    url:
      ...
      "?" +
      buildURLQuery(
        Object.assign(postData, { q: "upload", adapter: props.current.adapter, path: props.current.dirname }),
      ),
    // filters : [
