  ...
  <div class="vuefinder">
    <div :class="darkMode ? 'dark' : ''">
      <div
        ...
        class="flex min-w-min select-none flex-col border border-neutral-300 bg-white text-gray-700 dark:border-gray-900 dark:bg-gray-800 dark:text-neutral-400"
      ...
      <component :is="'v-f-modal-' + modal.type" v-if="modal.active" :selection="modal.data" :current="fetchData" />
